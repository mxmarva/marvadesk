...
Version: %s
Architecture: %s
Maintainer: Soluciones Marva <soporte@solucionesmarva.com>
Homepage: https://github.com/MarvaDesk/MarvaDesk
...
Description: MarvaDesk - Remote desktop software.
...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    if os.path.exists('./marvadesk_portable.exe'):
        ...
        os.rename('./target/release/marvadesk-portable-packer.exe',
                  './marvadesk_portable.exe')
    print(
...
def main():
    ...
    '''.format(pa, version))
                ...
                # build deb package
                system2(
                    'mv target/release/bundle/deb/*.deb ./marvadesk.deb')
