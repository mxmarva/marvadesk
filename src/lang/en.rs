...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_marvadesk_password_tip", "Verify MarvaDesk password"),
        ...
        ("upgrade_marvadesk_server_pro_to_{}_tip", "Please upgrade MarvaDesk Server Pro to version {} or newer!"),
        ("upgrade_marvadesk_server_pro_to_{1.1.10}_tip", "Please upgrade MarvaDesk Server Pro to version 1.1.10 or newer!"),
        ...
        ("About MarvaDesk", "About MarvaDesk"),
        ...
        ("upgrade_remote_MarvaDesk_client_to_{}_tip", "Please upgrade the MarvaDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, MarvaDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, MarvaDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, MarvaDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: MarvaDesk server OSS doesn't include this feature."),
