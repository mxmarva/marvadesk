...
# Linux: python3 generate.py -f ../marvadesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\marvadesk\flutter\build\windows\runner\Debug\ -o . -e ..\marvadesk\flutter\build\windows\runner\Debug\marvadesk.exe
