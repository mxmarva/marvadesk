...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem MarvaDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, MarvaDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate MarvaDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate MarvaDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno MarvaDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »MarvaDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep MarvaDesk background service", "Ohrani MarvaDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije MarvaDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "MarvaDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "MarvaDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_marvadesk_password_tip", "Preveri geslo za MarvaDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite MarvaDesk, prekinite klic in program zaprite."),
        ("scam_text2", "MarvaDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_marvadesk_server_pro_to_{}_tip", "Prosimo, nadgradite MarvaDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo MarvaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno MarvaDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri MarvaDesk storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_MarvaDesk_client_to_{}_tip", "Prosimo, nadgradite MarvaDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
