...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke MarvaDesk..."),
        ...
        ("install_tip", "Karena UAC, MarvaDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal MarvaDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk MarvaDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk MarvaDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd MarvaDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input MarvaDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep MarvaDesk background service", "Pertahankan MarvaDesk berjalan pada service background"),
        ...
        ("Show MarvaDesk", "Tampilkan MarvaDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada MarvaDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada MarvaDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC MarvaDesk yang sedang berjalan"),
        ...
        ("verify_marvadesk_password_tip", "Verifikasi Kata Sandi MarvaDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan MarvaDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_marvadesk_server_pro_to_{}_tip", "Silahkan perbarui MarvaDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah MarvaDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh MarvaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela MarvaDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service MarvaDesk agar tetap aktif"),
        ...
        ("About MarvaDesk", "Tentang MarvaDesk"),
        ...
        ("upgrade_remote_MarvaDesk_client_to_{}_tip", "Silahkan perbarui aplikasi MarvaDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
