...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään MarvaDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa MarvaDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi MarvaDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava MarvaDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava MarvaDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten MarvaDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota MarvaDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli MarvaDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "MarvaDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa MarvaDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "MarvaDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep MarvaDesk background service", "Pidä MarvaDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista MarvaDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show MarvaDesk", "Näytä MarvaDesk"),
        ...
        ("verify_marvadesk_password_tip", "Vahvista MarvaDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "MarvaDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_marvadesk_server_pro_to_{}_tip", "Päivitä MarvaDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About MarvaDesk", "Tietoa MarvaDeskistä"),
        ...
        ("upgrade_remote_MarvaDesk_client_to_{}_tip", "Päivitä etä-MarvaDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
